...
description: 'We track visits, not individual visitors.'
...
The choice to not ask for user consent for this is deliberate. We don't believe
it to be required by law, as we aren't able to identify individual visitors.
...
> of the processing and technological developments. <mark>The principles of data
...
> subject is not or no longer identifiable.</mark> This Regulation does not
> therefore concern the processing of such anonymous information, including for
> statistical or research purposes.

GoatCounter doesn't collect any personally identifiable information. It doesn't
store IP addresses, the full User-Agent header, or any kind of tracker ID. It
also doesn’t store any information in the browser with cookies, localStorage,
cache, or any other method.
...
The site is hosted at [Statichost.eu](https://www.statichost.eu), a
privacy-respecting service based in Sweden. They do not collect, store or
process any personal information related to website visits.

For details on what information is stored in their server logs, and for how
long, please refer to the Statichost
